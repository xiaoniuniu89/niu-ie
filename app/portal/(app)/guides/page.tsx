...
export default function GuidesPage() {
  return (
    <div>
      <h1 className="font-serif text-2xl font-semibold">Guides</h1>
      <p className="mt-2 max-w-prose text-muted-foreground">
        Step-by-step help for the things around your website: domains, email, payments, AI and more. Stuck on a step? Send a
        request from your project and Daniel will help.
      </p>
